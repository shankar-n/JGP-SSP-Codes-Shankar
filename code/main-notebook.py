...
def _(INSTANCES_PTH, load_ssp_instance):
    with open('./Instances/From_Felipe/data/files.txt') as f:
...
@app.cell
def _():
    from Instances.From_Felipe.instance_generator import generate_group
    OUT_DIR = "./Instances/Shankar/"
