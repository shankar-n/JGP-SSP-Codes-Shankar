...
settled negatively (Proposition~\ref{prop:notclutter}). (2) For
Question~\ref{q:ideal}, test integrality of the covering LP on the enumerated
families ($\le$ a few thousand instances) to locate candidate classes before
attempting proofs. (3) Bring Question~\ref{q:blocker} and the witnesses above
to the session with Prof.~Wagler; the prism/$C_5$ pair and the $I_0/I_1$ pair
are the instructive opening examples.
