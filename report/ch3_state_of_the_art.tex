...
That is where the compact models stop. The strongest compact relaxation produced in twenty years
coincides with a counting argument that fits in one sentence. \citet{daSilva2024}
...
methods for the SSP at all. No worst-case guarantee has been published for any SSP
heuristic, as far as could be determined during this internship.
...
polynomially solvable oracle, so the cut is exact and essentially free at every
callback.
...
Second, on the exact side the strongest compact relaxation equals the coverage bound
$q$ \citep{daSilva2024}, and the configuration relaxation does not improve on it on
