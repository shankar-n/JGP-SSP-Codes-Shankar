...
inequality~\eqref{eq:window} has roughly four times the remaining headroom
(Table~\ref{tab:ceilings}). It is valid, it is robust in the branch-and-price sense,
and it is implemented in \texttt{src/BNP/window\_cuts.py}. What remains is to measure it
inside the solver
