...
immediate in one direction: take any schedule and collapse each run of \emph{consecutive}
equal magazines to a single representative; what remains is a walk of the same cost that
serves every job. The
