...
$q$              & the tool excess, $q=\lvert\U\rvert-b$                        & \S\ref{ssec:lb} \\
$\pi$            & a job order (a permutation of $J$)                           & \S\ref{ssec:ssp} \\
$M_i$            & the magazine contents at position $i$                        & \S\ref{ssec:ssp} \\
$\Zst$           & the optimal switch cost of the instance                      & \S\ref{ssec:ssp} \\
...
$C$              & a configuration: a set of exactly $b$ tools                  & \S\ref{ssec:gtsp} \\
...
Every statement carries a label saying what kind of statement it is.
