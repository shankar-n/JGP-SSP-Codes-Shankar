...
results. The historical runner's incomplete resume key skipped $58$ planned pairs on
requeued shards; the full-key correction and completed exact-envelope recovery are stated in
Section~\ref{ssec:bench} and Appendix~\ref{app:repro}. The source audit also found that
