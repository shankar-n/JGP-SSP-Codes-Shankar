...
outer problem is hard. And the counting bound of $q=10$, which is what the strongest
compact linear relaxation in the literature returns, lies \emph{below the entire
...
fit in the initial magazine must be inserted at some point. So the strongest
relaxation a compact formulation currently offers is this counting argument, and a
solver relying on it cannot prove optimality where the bound is loose.
...
Every statement carries a label --- Theorem, Proposition, Lemma, Corollary,
