...
\includegraphics[width=\linewidth]{assets/report_figures/landscape.pdf}
...
\subsection{Why the problem is hard, and what was open}\label{ssec:intro-why}
...
two. How far
from optimal it can be, and on which instances it is exact, were open questions at the
start of this work.
