...
Draw instances with three to five jobs, four to eight tools, capacity between two and
five, and each job's requirement a uniformly random subset of admissible size. In
$1{,}260$ such instances, drawn as three independent samples of $420$, \emph{none} has
$H>\Zst$. Positive gaps nevertheless exist and are found by directed search: the
smallest is the four-job instance of Observation~\ref{obs:smallest}. Every positive
heuristic gap found anywhere in this study equals one, and every instance carrying one
has $b\ge4$.
\end{observation}

The last part of that observation matters. A positive heuristic gap
