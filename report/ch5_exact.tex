...
empty. The constraint matrix has the consecutive-ones property along the selected path
and is totally unimodular, so the relaxation is integral and, by
Proposition~\ref{prop:ktns}, its optimum equals $\KTNS$ of the order.
