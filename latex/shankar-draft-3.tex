...
\begin{document}
	...
	\begin{figure}[h!]
		...
		\begin{tikzpicture}[scale=0.9]
			...
			\draw[fill=green!20] (1, 1) rectangle (2, 1.5) node[midway, anchor=center, font=\small] {JGP LB};
			\draw[fill=lightgreen!20] (1, 1.5) rectangle (2, 2) node[midway, anchor=center, font=\small] {LP LB};
			\draw[fill=blue!20] (1, 2) rectangle (2, 2.5) node[midway, anchor=center, font=\small] {OPT*};
			\draw[fill=salmon!20] (1, 2.5) rectangle (2, 3.5) node[midway, anchor=center, font=\small] {UB WS};
			\draw[fill=coral!20] (1, 3.5) rectangle (2, 4.5) node[midway, anchor=center, font=\small] {UB Greedy};
			
			% Tightening as solver improves
			\draw[dashed, gray] (2, 1) -- (9, 1.2) node[midway, above, font=\small] {JGP improves};
			\draw[dashed, gray] (2, 2) -- (9, 2.3) node[midway, above, font=\small] {OPT found};
			\draw[dashed, gray] (2, 3.5) -- (9, 3.7) node[midway, above, font=\small] {UB tightens};
			
			% Gap arrow
			\draw[<->, red, thick] (0.5, 1) -- (0.5, 3.5) node[midway, left, font=\small, red] {Gap};
		\end{tikzpicture}
		\caption{Bounds hierarchy: LB $\le$ OPT* $\le$ UB. As algorithms tighten bounds, gap shrinks, reducing uncertainty about optimal value.}
